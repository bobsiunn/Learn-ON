...
코로나 19 이후 거리두기가 실행되면서, 국내외 정부/교육기관 차원에서 온라인 수업을 권고하였다.  
국내 40%이상 대학이 2020년 전면 온라인을 실시하였으며, 코로나가 끝난 이후에도 온라인 강의를 확대해 적극적으로 활용할 것임을 밝혔다.  
IMBA와 같은 온라인 학습을 통한 학위 취득 과정도 더욱 확대되고 있으며, 이에 따라 글로벌 에듀테크 지출이 커지며 에듀테크 시장에 가속세가 붙었다.  
이처럼, 온라인 학습만이 가지는 장점이 분명 있는 와중에 앞으로 그 시장이 더욱 확대됨에 따라 이를 적극적으로 활용할 방안이 필요하다고 판단하였다.  
